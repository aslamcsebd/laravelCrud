      ...
      <div class="row justify-content-center home">
         <div class="col-12 col-lg-12 col-md-4 col-sm-6 col-sm-12 mt-2 mb-2 space">
            <div class="card">             
               ...
               <div class="card-header text-light text-center bg-success">Employee Info [{{ $Salaries->count() }}]</div>
               <div class="py-2" align="center"><a href="{{ url('printPDF') }}" class="btn-sm btn-info">Print PDF</a></div>
                     ...
                     <table class="table singer_list_table table-bordered">
                        ...
                        <tbody>
                           @foreach($Salaries as $Salary)
                              <tr class="text-center">
                                 <td>  <img src="{{asset('photo')}}/{{$Salary->salaryToemployee->photo}}" alt="No Image found" width="60" /></td>               
