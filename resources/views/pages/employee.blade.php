                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('add_employee') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="password"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Date of Birth') }}
                                </label>

                                <div class="col-md-6">
                                    <input type="text" id="datepicker" name="dob" value="{{ old('dob') }}"
                                        placeholder="Insert date" class="form-control">
                                </div>
                            </div>
