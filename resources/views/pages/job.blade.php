                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('add_Job') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="name"
                                    class="col-md-3 col-form-label text-md-right">{{ __('Position Name') }}</label>
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="position"
                                        value="{{ old('position') }}" required autocomplete="name"
                                        placeholder="Add Position Name" autofocus>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ url('job_delete') }}/{{ $JobType->id }}"
